...
![Class Diagram Overview](src/images/jobsmarter-overview-CD.png)
...
![Get User Endpoint SD](src/images/GetUserActivity-SD.png)
...
![Create User Endpoint SD](src/images/CreateUserActivity-SD.png)
...
![Update User Endpoint SD](src/images/UpdateUserActivity-SD.png)
...
![Create Job Application Endpoint SD](src/images/createJobApplication-SD.png)
...
![Update Job Application Endpoint SD](src/images/updateJobApplication-SD.png)
...
![Get Job Application Endpoint SD](src/images/getJobApplication-SD.png)
...
![Get All Job Application Endpoint SD](src/images/getAllJobApplications-SD.png)
...
![Delete Job Application Endpoint SD](src/images/deleteJobApplication-SD.png)
...
![Get Question Endpoint SD](src/images/getQuestion-SD.png)
...
![Create Question Endpoint SD](src/images/createQuestion-SD.png)
...
![Update Question Endpoint SD](src/images/updateQuestion-SD.png)
...
![Add Question to Job Application Endpoint SD](src/images/addQuestionToJobApplication-SD.png)
...
![Get All Questions Endpoint SD](src/images/getAllQuestion-SD.png)

# 7. Tables

![ERD](src/images/jobsmarter-entity.png)
...
![Mockup of our frontend design](src/images/jobsmarter-frontend-flow.png)